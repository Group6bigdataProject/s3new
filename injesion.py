...
# Write to Parquet
df4.coalesce(1).write.parquet("s3://group-6-datalakenew23re6dlrefyutilast/street/", mode="append")
...
# Write to Parquet
df2.repartition(90).write.parquet("s3://group-6-datalakenew23re6dlrefyutilast/outcomes/", mode="append")
