...
df1 = spark.read.parquet("s3://group-6-datalakenew23re6dlrefyutilast/street/")
...
df1.write.mode("append").parquet("s3://group-6-datawarehousenewrte6dwtyyfreelast/STREET")

# Read data from outcomes for transformation
df2 = spark.read.parquet("s3://group-6-datalakenew23re6dlrefyutilast/outcomes/")
...
df2.write.mode("append").parquet("s3://group-6-datawarehousenewrte6dwtyyfreelast/OUTCOMES")
